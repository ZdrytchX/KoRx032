...
#if CLIENTNUM_BITS <= 7			// if we have up to 128 (1<<7 = 128) clients we can use
  #define CLIENTNUM_TYPE char		// char to store the clientnum.
#else					// if we have more
  #define CLIENTNUM_TYPE short		// we have to use short int
#endif
