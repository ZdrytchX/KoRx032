...
#define ABGRANGER_CLAW_WIDTH         6.0f
#define ABGRANGER_CLAW_REPEAT        750
#define ABGRANGER_CLAW_K_SCALE       1.0f
#define ABGRANGER_BLOB_DMG           ADM(10)
#define ABGRANGER_BLOB_REPEAT        750
...
#define SPITFIRE_SPITBOMB_SPEED      500.0f
#define SPITFIRE_SPITBOMB_RANGE      150.0f
#define SPITFIRE_SPITBOMB_DMG        ADM(35)
#define SPITFIRE_SPITBOMB_REGEN      3000
#define SPITFIRE_EBLOB_BUILDABLE     0.60f

#define SPITFIRE_UPG_ZAP_REPEAT          500
#define SPITFIRE_UPG_SPITBOMB_THINK_TIME 5000
#define SPITFIRE_UPG_SPITBOMB_REPEAT     500
#define SPITFIRE_UPG_SPITBOMB_SPEED      500.0f
#define SPITFIRE_UPG_SPITBOMB_RANGE      150.0f
#define SPITFIRE_UPG_SPITBOMB_DMG        ADM(60)
#define SPITFIRE_UPG_SPITBOMB_REGEN      3000
#define SPITFIRE_UPG_EBLOB_BUILDABLE     0.75f
...
#define LEVEL3_CLAW_UPG_DMG         ADM(90)
#define LEVEL3_CLAW_RANGE           76.0f
...
#define LEVEL3_POUNCE_UPG_DMG       ADM(85)    
...
#define LEVEL4_EBLOB_REGEN          BOOST_TIME-1000 // one blob a boost
...
#define ABGRANGER_VALUE             AVM(350)
#define ABGRANGER_HEALTH            AHM(150)
...
#define SPITFIRE_VALUE              AVM(350)
#define SPITFIRE_HEALTH             AHM(50)
#define SPITFIRE_REGEN              2
#define SPITFIRE_REGEN_MSEC         ARMSEC(SPITFIRE_HEALTH)
#define SPITFIRE_COST               1

#define SPITFIRE_UPG_SPEED          0.9f
#define SPITFIRE_UPG_VALUE          AVM(500)
#define SPITFIRE_UPG_HEALTH         AHM(100)
#define SPITFIRE_UPG_REGEN          3
#define SPITFIRE_UPG_REGEN_MSEC     ARMSEC(SPITFIRE_UPG_HEALTH)
#define SPITFIRE_UPG_COST           1
...
#define LEVEL4_UPG_VALUE            AVM(1400)
...
#define ALIEN_BVALUE_MODIFIER       1.0f
...
#define OVERMIND_VALUE              ABVM(1600)
...
#define MDRIVER_SURGE_DMG_MOD       1.15f
#define MDRIVER_SURGE_TIME_MOD      0.8f
...
#define CHAINGUN_PRI_RECOIL_MIN_Y   0.10
#define CHAINGUN_PRI_RECOIL_MAX_Y   1.0
#define CHAINGUN_PRI_RECOIL_MAX_X   1
#define CHAINGUN_PRI_RECOIL_SOFTEN  0.75
#define CHAINGUN_SEC_RECOIL_MIN_Y   0.2
#define CHAINGUN_SEC_RECOIL_MAX_Y   1.3
#define CHAINGUN_SEC_RECOIL_MAX_X   1.5
...
#define CLOAK_TIME                  BOOST_TIME/1000
...
#define JETPACK_STD_CHARGE_RATE     0.5   // x JPU/s (Onboard Recharge)
#define JETPACK_RC_CHARGE_RATE      2.5   // x JPU/s (Reactor Charge Bonus) (RC Up = RC Charge Bonus + Onboard Charge Rate)
#define JETPACK_STD_CHARGE_DELAY    5000  // (ms) When jetpack turns off, start self-recharge after this delay
...
#define JETPACK_EXPLODE_CHANCE      .0005f  // Chance that the jetpack will explode, as a float, not percent
...
#define HSPAWN_VALUE                HBVM(200/50)
...
#define HUMAN_SPAWN_TELEPORT_TIME   5000
...
#define CREDIT_TO_FRAG_RATIO        ((float)FREEKILL_ALIEN/(float)FREEKILL_HUMAN)

#define DEFAULT_STAGE2_THRESH       "4000"
#define DEFAULT_STAGE3_THRESH       "8000"

#define DEFAULT_ALIEN_BUILDPOINTS   "100"
#define DEFAULT_ALIEN_QUEUE_TIME    "1250"
#define DEFAULT_ALIEN_STAGE2_THRESH DEFAULT_STAGE2_THRESH
#define DEFAULT_ALIEN_STAGE3_THRESH DEFAULT_STAGE3_THRESH

#define DEFAULT_ALIEN_MAX_STAGE     "2"
#define DEFAULT_HUMAN_BUILDPOINTS   "100"
#define DEFAULT_HUMAN_QUEUE_TIME    "1250"
#define DEFAULT_HUMAN_STAGE2_THRESH DEFAULT_STAGE2_THRESH
#define DEFAULT_HUMAN_STAGE3_THRESH DEFAULT_STAGE3_THRESH
#define DEFAULT_HUMAN_MAX_STAGE     "2"

// The number of players divided by this number times the default thresholds
// yields the required credits for stageup
#define HUMAN_PLAYER_COUNT_MOD 6.0f
#define ALIEN_PLAYER_COUNT_MOD 6.0f
/*
  SKIRMISH_TIME
...
// Time it takes for everyone to die in VESD (1.5 minutes)
#define VAMPIRIC_ESD_TTD            90000

// Time it takes for humans to regen all their ammo (1.5 minutes)
#define VAMPIRIC_ESD_TAR            90000
