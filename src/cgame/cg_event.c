...
static void CG_Obituary( entityState_t *ent )
{
  ...
  if( attacker == target )
  {
    ...
    switch( mod )
    {
      ...
      case MOD_SLAP:
        if( gender == GENDER_FEMALE )
          message = "slapped herself silly";
        else if( gender == GENDER_NEUTER )
          message = "slapped itself silly";
        else
          message = "slapped himself silly";
        break;
  ...
  if( attacker == ENTITYNUM_WORLD )
  {
    ...
    {
      case MOD_SLAP:
        message = "felt console's authority";
        break;
      case MOD_KILL:
        message = "was killed by console";
        break;
    }
  }
