...
void CG_Menu( int menu, int arg )
{
  ...
  switch( menu )
  {
   ...
   case MN_CMD_DEAD:
      //longMsg   = "You must be living to perform this action.";
      shortMsg  = "Must be dead to use this command";
      type      = DT_COMMAND;
      break;
    ...
    case MN_B_NOGUIDNOBUILD:
      shortMsg  = "^1You need to get the new client at: tremfusion.net in order "
                  "to build on this server. See the help menu (esc->help) for more info.\n"
                  
                  "Du musst einen neue Version von Tremulous auf tremfusion.net "
                  "herunterladen, um auf diesem Server bauen zu konnen. "
                  "Für weitere Informationen sieh im Hilfe Menu nach (esc->help).\n"
                  
                  "Vous devez telecharger le nouveau client ici: tremfusion.net pour "
                  "pouvoir construire sur ce serveur. Voir le menu d'aide (esc>help) pour "
                  "plus d'informations.\n"
                  
                  "Zeby budowac na tym serwerze potrzebujesz nowego klienta: "
                  "tremfusion.net. Szczegoly w menu pomocy (esc->help).\n"
      
                  "Necesidad de obtener el nuevo cliente en: tremfusion.net "
                  "a fin de construir en este servidor. Ver el menu de ayuda "
                  "(ESC-> Help) para obtener mas informacion.";
      break;
